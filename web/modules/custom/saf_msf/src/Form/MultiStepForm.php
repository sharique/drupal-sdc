 ...
 */
final class MultiStepForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    switch ($form_state->getTemporaryValue('step')) {
      case 1:
        return $this->buildDateForm($form, $form_state);
      case 2:
        return $this->buildTimeForm($form, $form_state);
      case 3:
        return $this->buildContactForm($form, $form_state);
      case 4:
  ...
  public function dateFormSubmit(array &$form, FormStateInterface $form_state): void {
  ...
  public function timeFormSubmit(array &$form, FormStateInterface $form_state): void {
